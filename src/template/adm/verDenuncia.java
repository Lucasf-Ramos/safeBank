...
public class verDenuncia extends javax.swing.JFrame {
    ...
    private static Denuncia _denuncia;
    ...
    public verDenuncia(long id) {
        initComponents();

        DenunciaDAO denunciaDAO = new DenunciaDAO();
        
        var denuncia = denunciaDAO.buscarPorId(id);
        
        _denuncia = denuncia;
        
        denunciaTitle.setText("Denuncia " + id);
        denunciado.setText("Denunciado: " + denuncia.getTransferencia().getContaDestino().getCliente().getNome());
        denunciante.setText("Denunciante: " + denuncia.getTransferencia().getContaOrigem().getCliente().getNome());
        resumo.setText(denuncia.getDescricao());
    }
    ...
    private void initComponents() {
        ...
        denunciaTitle.setText("Denuncias");
